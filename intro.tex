...
\includegraphics{pictures/Convergence4.png}
...
\begin{itemize}
    ...
    \item if $e$ is a smooth error, the interpolation needs to accurately represent it (smooth errors must be close to the $\range(P)$)
\end{itemize}

% the role of the smoother is to take care of everything not in range(P). The 2-grid operator will take care of the rest.
